...
function SwitchPage() {
  return (
    <ElementsContainer>
      {/* Breadcrumb  element*/}
      <ElementsBreadcrumb page="Switch" />
      {/* Element name */}
      <ElementsName
        name="Switch"
      ...
      <Div>
        <Tabs defaultValue="cli" className="w-full flex flex-col gap-6">
          ...
          <TabsContent value="cli">
            <Code>npm install tailfront@latest elements switch</Code>
          </TabsContent>
          {/* Installation Manual */}
          <TabsContent value="manual" className="w-full">
            <div className="flex flex-col gap-1">
              ...
              <ElementSteps
                ...
                className="pb-4"
              >
                <Code>{switchSecondStepCode}</Code>
              </ElementSteps>
              {/* Third step */}
              <ElementSteps
                step={3}
      ...
      {/* Usage */}
      <ElementsUsage>
        <Code>{switchUsageCode}</Code>
        <Code>{switchUsageTwoCode}</Code>
      </ElementsUsage>
      {/* API reference table */}
      <ElementsRef>
        <ElementsReference
