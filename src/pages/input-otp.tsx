...
function InputOTPPage() {
  return (
    <ElementsContainer>
      {/* Breadcrumb  element*/}
      <ElementsBreadcrumb page="Input OTP" />
      {/* Element name */}
      <ElementsName
        name="Input OTP"
      ...
      <Div>
        <Tabs defaultValue="cli" className="w-full flex flex-col gap-6">
          ...
          <TabsContent value="cli">
            <Code>npm install tailfront@latest elements input-otp</Code>
          </TabsContent>
          {/* Installation Manual */}
          <TabsContent value="manual" className="w-full">
            <div className="flex flex-col gap-1">
              ...
              <ElementSteps
                ...
                className="pb-4"
              >
                <Code>{inputotpSecondStepCode}</Code>
              </ElementSteps>
              {/* Third step */}
              <ElementSteps
                step={3}
      ...
      {/* Examples */}
      <ElementsExample>
        <Example header="Default" size="sm" />
        <ExampleTwo header="With Separator" size="sm" />
        <ExampleThree header="With Slot" size="sm" />
      </ElementsExample>
      <NavigationButtons />
    </ElementsContainer>
  );
