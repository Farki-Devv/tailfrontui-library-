...
function SkeletonPage() {
  return (
    <ElementsContainer>
      {/* Breadcrumb  element*/}
      <ElementsBreadcrumb page="Skeleton" />
      {/* Element name */}
      <ElementsName
        name="Skeleton"
      ...
      <Div>
        <Tabs defaultValue="cli" className="w-full flex flex-col gap-6">
          ...
          <TabsContent value="cli">
            <Code>npm install tailfront@latest elements skeleton</Code>
          </TabsContent>
          {/* Installation Manual */}
          <TabsContent value="manual" className="w-full">
            <div className="flex flex-col gap-1">
              ...
              <ElementSteps
                ...
                className="pb-4"
              >
                <Code>{skeletonSecondStepCode}</Code>
              </ElementSteps>
              {/* Third step */}
              <ElementSteps
                step={3}
      ...
      {/* Usage */}
      <ElementsUsage>
        <Code>{skeletonUsageCode}</Code>
        <Code>{skeletonUsageTwoCode}</Code>
      </ElementsUsage>
      {/* API reference table */}
      <ElementsRef>
        <ElementsReference
