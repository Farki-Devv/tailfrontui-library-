...
function LabelPage() {
  return (
    <ElementsContainer>
      ...
      <Div>
        <Tabs defaultValue="cli" className="w-full flex flex-col gap-6">
          ...
          <TabsContent value="cli">
            <Code>npm install tailfront@latest elements label</Code>
          </TabsContent>
          {/* Installation Manual */}
      ...
      {/* Usage */}
      <ElementsUsage>
        <Code>{labelUsageCode}</Code>
        <Code>{labelUsageTwoCode}</Code>
      </ElementsUsage>
      {/* API reference table */}
      <ElementsRef>
        <ElementsReference
