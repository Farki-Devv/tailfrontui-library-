...
function DropdownMenuPage() {
  return (
    <ElementsContainer>
      {/* Breadcrumb  element*/}
      <ElementsBreadcrumb page="Dropdown Menu" />
      {/* Element name */}
      <ElementsName
        name="Dropdown Menu"
        description="Displays a menu to the user as a set of actions or functions that can be triggered by a button. Install and use in sequence"
      >
      ...
      <Div>
        <Tabs defaultValue="cli" className="w-full flex flex-col gap-6">
          ...
          <TabsContent value="cli">
            <Code>npm install tailfront@latest elements dropdown-menu</Code>
          </TabsContent>
          {/* Installation Manual */}
          <TabsContent value="manual" className="w-full">
            <div className="flex flex-col gap-1">
              ...
              <ElementSteps
                ...
                className="pb-4"
              >
                <Code>{dropdownMenuSecondStepCode}</Code>
              </ElementSteps>
              {/* Third step */}
              <ElementSteps
                step={3}
      ...
      {/* Usage */}
      <ElementsUsage>
        <Code>{dropdownmenuUsageCode}</Code>
        <Code>{dropdownmenuUsageTwoCode}</Code>
      </ElementsUsage>
      {/* API reference table */}
      <ElementsRef>
        <ElementsReference
      ...
      {/* Examples */}
      <ElementsExample>
        <ExampleTwo header="Checkboxes" description="" size="sm" />
        <ExampleThree header="Radio Group" description="" size="sm" />
      </ElementsExample>
      <NavigationButtons />
    </ElementsContainer>
  );
...
const ExampleTwo = ({ header, description, padding, size }: ExampleProps) => {
  ...
  return (
    <ElementsExampleTabs
      ...
      description={description}
      padding={padding}
      elementCode={dropdownmenuTwoCode}
    >
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="outline">Open</Button>
...
const ExampleThree = ({ header, description, padding, size }: ExampleProps) => {
  ...
  return (
    <ElementsExampleTabs
      ...
      description={description}
      padding={padding}
      elementCode={dropdownmenuThreeCode}
    >
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="outline">Open</Button>
