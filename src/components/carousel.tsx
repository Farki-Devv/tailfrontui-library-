/**
 * @file carousel.tsx
 * @overview A carousel with motion and swipe built using Embla.
    ...
    <CarouselContent>
      {Array.from({ length: 2 }).map((_, index) => (
        <CarouselItem key={index}>
          <div className="p-1">
            <Card>
              <CardContent className="flex aspect-square items-center justify-cente  p-6">
 ...
 * @npx i tailftont elements button
 */
/** Tayyor emas! Tayyor emas!  */
